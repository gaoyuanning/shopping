		...
		<div class="leftmenu1">
			...
			<ul>
				...
				<li><a class="a_list a_list3">订单管理</a>
					<div class="menu_list">
						<a href="order.jsp">订单浏览</a> <a href="#">添加新闻</a> <a href="#">修改新闻</a> <a
							href="#">删除新闻</a>
					</div></li>
			</ul>
		</div>
			...
			<div class="right_con">
				<table border="1">
					...
					<tr>
						...
						<td><a href="productdelete.jsp?id=<%=p.getId()%>"
							target="detail" onclick="return confirm('确认删除')">删除</a> &nbsp;&nbsp; <a
							href="productmodify.jsp?id=<%=p.getId()%>" target="detail">修改</a>
							 <a
							href="uploadProductImage.jsp?id=<%=p.getId()%>" target="detail">上传图片</a>
						</td>
					</tr>
					<%
						}
